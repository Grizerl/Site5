<footer>
    <div class="footer">
        <div class="footer-content">
            <div>
                <img class="logo" src="https://asteria.sivium.solutions/storage/img/logo.png" alt="Logo Asteria">
            </div>
            <div class="section">
                <p class="subtitle" >No player is connected!</p>
                <h1 class="caption" >Welcome to Asteria</h1>
                <p class="subtitle-2" >Beta is open!</p>
                <span class="button" >playasteria.sivium.solutions</span>
                <span class="button-2" >Download the launcher</span>
            </div>
        </div>
    </div>
